...
const description = 'Especializado en fotografía y maquillaje de alimentos';
          ...
          {items.map((item, index) => (
            <div className="lg:w-1/3 sm:w-1/2 p-4" key={index}>
              <div className="flex relative">
                <Image alt="gallery" className="absolute inset-0 w-full h-full object-cover object-center" src={item.imageSrc} />
